...
4. Verify response summary shows correct `communityId`, `total: 10`, `created: 10`, `failed: 0`.
...
3. Verify response status is 200 OK.
4. Verify response summary shows correct `communityId`, `total: 6`, `created: 6`, `failed: 0`.
